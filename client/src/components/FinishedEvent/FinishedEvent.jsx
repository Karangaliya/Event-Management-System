...
function FinishedEvent() {
    ...
    useEffect(() => {
        const fetchEvents = async () => {
            axios.get(`https://event-management-system-backend-n47r.onrender.com/api/v1/users/FinishedAllEvent/${currentUser._id}`)
    ...
    return (
        <div className='min-h-[100vh] space-y-5'>
            <div className='text-2xl font-semibold w-full text-center'>Finished Events</div>
